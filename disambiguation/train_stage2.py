...
if __name__ == "__main__":
    ...
    window, channel, sent_aligned, subset = 256, "both", True, "conll"
    # stage_a_error_analysis(window=window, subset=subset, channel=channel)
    ...
    # GNN Stage B — current best config (lse member pooling + concatenated lexical = 86.30 fixed-K):
    train_stage_b(
        window=window,
        subset=subset,
        channel=channel,
